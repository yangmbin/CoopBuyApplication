...
//        int width = MeasureSpec.getSize(widthMeasureSpec);
        ...
        Log.e("yangmbin", "mBarHeight:" + mBarHeight);
        int height = (int) mBarHeight + (int) dp2px(30);
        int width = MeasureSpec.getSize(widthMeasureSpec);
...
//        mFirstItemBaseLineY = (mIndexItemHeight/2 - (fontMetrics.descent-fontMetrics.ascent)/2) - fontMetrics.ascent;
    }
