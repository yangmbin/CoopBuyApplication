...
public class HomeLayoutAdapter_7_2 extends BaseDelegateAdapter<Object> {

    private List<Object> floorItems;

    public HomeLayoutAdapter_7_2(Context ctx, List<Object> list, LayoutHelper mLayoutHelper) {
