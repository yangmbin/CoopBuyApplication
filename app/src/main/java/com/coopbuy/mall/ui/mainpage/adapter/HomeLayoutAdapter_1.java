...
public class HomeLayoutAdapter_1 extends BaseDelegateAdapter<HomeFloorResponse> {


    public HomeLayoutAdapter_1(Context ctx, List<HomeFloorResponse> list, LayoutHelper mLayoutHelper) {
