...
public class WaitPayOrderFragment extends ViewPagerBaseFragment<OrderPresenter, OrderModel> implements Order_IView, OnRefreshLoadmoreListener {
    ...
    protected void onFragmentFirstVisible() {
        mPresenter.getOrderList(OrderPresenter.ORDER_STATUS_WAIT_PAY, firstPage, OrderPresenter.LOAD_TYPE_1);
    }

    @Override
    public void onLoadmore(RefreshLayout refreshlayout) {
        mPresenter.getOrderList(OrderPresenter.ORDER_STATUS_WAIT_PAY, currentPage + 1, OrderPresenter.LOAD_TYPE_3);
    }

    @Override
    public void onRefresh(RefreshLayout refreshlayout) {
        mPresenter.getOrderList(OrderPresenter.ORDER_STATUS_WAIT_PAY, firstPage, OrderPresenter.LOAD_TYPE_2);
    }
