...
public class WaitReceiveOrderFragment extends ViewPagerBaseFragment<OrderPresenter, OrderModel> implements Order_IView, OnRefreshLoadmoreListener {
    ...
    public void onLoadmore(RefreshLayout refreshlayout) {
        mPresenter.getOrderList(OrderPresenter.ORDER_STATUS_WAIT_RECEIVE, currentPage + 1, OrderPresenter.LOAD_TYPE_3);
    }

    @Override
    public void onRefresh(RefreshLayout refreshlayout) {
        mPresenter.getOrderList(OrderPresenter.ORDER_STATUS_WAIT_RECEIVE, firstPage, OrderPresenter.LOAD_TYPE_2);
    }
