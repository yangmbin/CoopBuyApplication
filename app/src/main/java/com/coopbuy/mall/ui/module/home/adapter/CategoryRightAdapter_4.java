...
public class CategoryRightAdapter_4 extends BaseDelegateAdapter<Object> {

    public CategoryRightAdapter_4(Context ctx, List<Object> list, LayoutHelper mLayoutHelper) {
